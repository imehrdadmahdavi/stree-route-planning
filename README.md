...
```
./OSM_A_star_search
[s_x s_y e_x e_y] (Enter four input arguments for the starting and ending points coordinates as shown in the image above. Each coordinate's value should be between 0 and 100)
```
